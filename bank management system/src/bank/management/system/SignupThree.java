...
public class SignupThree extends JFrame implements ActionListener
{
    ...
    SignupThree(String formno)
    {
        ...
        JLabel number= new JLabel("XXX-XXX-XXX-4184");
        ...
        services.setBounds(100, 450, 400,24);
        add(services);
        ...
        submit.addActionListener(this);//when this button is clicked submit action will be stored or saved
        add(submit);
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        if(ae.getSource()==submit)
        {
         ...
         String facility="";  //to concat multiple options
         if(c1.isSelected())
